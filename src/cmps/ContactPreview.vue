<template>
    <article class="contact-preview flex column gap-1">
        <div class="emblem-and-name flex row align-center gap-1">
            ...
            <div class="flex column phone-and-name">
                <h2>{{ contact.name }}</h2>
                <div class="phone flex align-center gap-1"><font-awesome-icon icon="fa-solid fa-phone" /><span>{{
                    contact.phone
                }}</span>
                </div>
            </div>
